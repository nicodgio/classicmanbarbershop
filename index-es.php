...
<body class="bg-black text-gray-100">
    ...
    <div class="container mx-auto px-4 py-4">
      <div class="flex items-center justify-between">
        ...
        <div class="hidden lg:flex items-center space-x-8">
          <a href="#hero" class="text-gray-300 hover:text-yellow-600 transition">Inicio</a>
          <a href="#about-us" class="text-gray-300 hover:text-yellow-600 transition">Nosotros</a>
          <a href="#services" class="text-gray-300 hover:text-yellow-600 transition">Servicios</a>
          <a href="cm/login.php" class="text-gray-300 hover:text-yellow-600 transition"><i
              class="fas fa-user"></i></a>
          <a href="https://www.classicmanbarbershop.com.mx" target="_self">
            <img src="./imgs/eu.png" alt="English" class="h-8">
          </a>
        </div>
      ...
      <div id="mobile-menu" class="hidden lg:hidden mt-4 pb-4 space-y-4">
        <a href="#hero" class="block text-gray-300 hover:text-yellow-600 transition">Inicio</a>
        <a href="#about-us" class="block text-gray-300 hover:text-yellow-600 transition">Nosotros</a>
        <a href="#services" class="block text-gray-300 hover:text-yellow-600 transition">Servicios</a>
        <a href="cm/login.php" class="block text-gray-300 hover:text-yellow-600 transition">Ingresar</a>
        <a href="https://www.classicmanbarbershop.com.mx" target="_self"
    ...
    <div class="container mx-auto px-4">
      <div class="max-w-2xl fade-in">
        ...
        <p class="text-xl md:text-2xl mb-8 text-gray-200">
          Bienvenido a Classicman Barbershop, donde la artesanía atemporal se une al estilo moderno.
        </p>
        <a href="#services"
      ...
      <div class="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <p class="text-gray-300 text-lg mb-8">
            Combinamos la artesanía clásica de barbería con estilo moderno para ofrecer servicios de aseo impecables.
          </p>
          <div class="grid md:grid-cols-2 gap-6">
            <div class="flex items-start space-x-4">
              <i class="fas fa-cut text-yellow-600 text-3xl"></i>
              <div>
                <h6 class="text-white font-semibold mb-2">Cortes Clásicos</h6>
                <p class="text-gray-400 text-sm">Estilos tradicionales, no muy cortos, con un acabado elegante y
                  distintivo.</p>
              </div>
            </div>
            <div class="flex items-start space-x-4">
              ...
              <div>
                <h6 class="text-white font-semibold mb-2">Degradados</h6>
                <p class="text-gray-400 text-sm">Tendencia moderna adecuada para todo tipo de cabello y edades.</p>
              </div>
            </div>
            <div class="flex items-start space-x-4">
              <i class="fa-solid fa-face-meh-blank text-yellow-600 text-3xl"></i>
              <div>
                <h6 class="text-white font-semibold mb-2">Arreglo de Barba</h6>
                <p class="text-gray-400 text-sm">Estilos variados según la forma del rostro y el tipo de barba.</p>
              </div>
            </div>
            <div class="flex items-start space-x-4">
              <i class="fas fa-female text-yellow-600 text-3xl"></i>
              <div>
                <h6 class="text-white font-semibold mb-2">Cortes para Dama</h6>
                <p class="text-gray-400 text-sm">Variedad de estilos para reflejar tu personalidad.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center fade-in">
        <div>
          ...
          <p class="text-gray-300 text-lg mb-4 leading-relaxed">
            En Classic Man fusionamos <strong class="text-yellow-600">barbería clásica</strong> con técnicas modernas
            para crear experiencias de aseo personalizadas.
          </p>
          <p class="text-gray-300 text-lg mb-6 leading-relaxed">
            Nuestro equipo garantiza <em class="text-yellow-600">precisión</em> y <em
              class="text-yellow-600">detalles cuidados</em> en cada corte y afeitado.
          </p>

          <div class="mb-8">
            <p class="text-white font-semibold mb-3">Síguenos en redes sociales:</p>
  ...
  <section id="services" class="py-20 bg-black">
    <div class="container mx-auto px-4">
      <h2 class="text-4xl md:text-5xl font-bold text-center mb-12 text-white">NUESTROS SERVICIOS</h2>
          ...
          <?php if ($category === 'OTROS SERVICIOS'): ?>
            <div class="mt-8 bg-gray-800 rounded-xl p-6 border-l-4 border-yellow-600">
              <p class="text-gray-300">
                Los precios varían según el producto requerido. Para más información o para agendar una cita, envíanos
    ...
    <div class="container mx-auto px-4">
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div class="text-center lg:text-left">
          <h2 class="text-4xl font-bold mb-8 text-white">Encuéntranos</h2>
          <div class="space-y-4 text-gray-300 text-lg">
            ...
            <p class="flex items-start justify-center lg:justify-start">
              ...
              <span>Lun – Sáb: 10 am – 8 pm<br>Dom: 10 am – 5 pm</span>
            </p>
          </div>
        </div>
